...
<body>
  <div class="navbar bg-base-100">
    <div class="flex-1">
      <a class="btn btn-ghost normal-case text-lg">Bulletin Board</a>
    </div>
    <div class="relative">
      <div class="btn btn-sm bg-transparent border-0 relative hover:bg-transparent">
      ...
      <div class="dropdown dropdown-end ml-4">
        <label tabindex="0" class="btn btn-ghost btn-circle avatar">
          <div class="w-10 rounded-full">
            <img src="https://kit8.net/wp-content/uploads/edd/2022/04/kit8net-Business-Collection_Header.jpg" />
          </div>
        </label>
